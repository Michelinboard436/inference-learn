...
- [9.1 为什么必须数值验证](#91-为什么必须数值验证)
- [9.2 单 token 验证法](#92-单-token-验证法)
- [9.3 ASan：编译器自带的内存错误检测器](#93-asan编译器自带的内存错误检测器)
- [9.4 逐层 dump：二分定位 bug](#94-逐层-dump二分定位-bug)
- [9.5 验证清单](#95-验证清单)
- [9.6 推荐学习路径](#96-推荐学习路径)
- [9.7 一句话总结](#97-一句话总结)
