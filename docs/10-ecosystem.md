...
- [10.1 一张图看懂四种实现](#101-一张图看懂四种实现)
- [10.2 技术栈分层对比](#102-技术栈分层对比)
- [10.3 为什么不能「一个引擎跑所有模型」](#103-为什么不能一个引擎跑所有模型)
- [10.4 算得快 vs 调度好](#104-算得快-vs-调度好)
- [10.5 为什么用 GPU 不用 CPU](#105-为什么用-gpu-不用-cpu)
- [10.6 性能差距从哪来](#106-性能差距从哪来)
- [10.7 大模型装不下怎么办：5 种加载方案](#107-大模型装不下怎么办5-种加载方案)
- [10.8 vLLM 的依赖清单解读](#108-vllm-的依赖清单解读)
- [10.9 各引擎适用场景](#109-各引擎适用场景)
- [10.10 从手写引擎到工业引擎的演进路径](#1010-从手写引擎到工业引擎的演进路径)
- [10.11 具体差什么：本项目 vs vLLM vs SGLang](#1011-具体差什么本项目-vs-vllm-vs-sglang)
- [10.12 核心洞察](#1012-核心洞察)
- [10.13 一句话总结](#1013-一句话总结)
...
### 10.4.3 PagedAttention：KV Cache 的内存管理
...
### 10.5.3 这就是为什么 Transformer 天生适合 GPU
...
### 10.7.3 方案 ②：张量并行（Tensor Parallelism）—— 切矩阵
...
### 10.7.4 方案 ③：流水线并行（Pipeline Parallelism）—— 切层
...
### 10.7.5 方案 ④：CPU 卸载（Offloading）—— 按需搬
...
## 10.11 具体差什么：本项目 vs vLLM vs SGLang
...
### 10.11.4 vLLM vs SGLang（两个顶级引擎的对比）
