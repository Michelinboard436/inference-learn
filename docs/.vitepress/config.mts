...
const zhThemeConfig = {
  ...
  sidebar: [
    {
      text: '📖 开始阅读',
      items: [{ text: '目录与阅读路径', link: '/README' }]
    },
    {
      text: 'Part 1 · 基础',
      items: [
  ...
  footer: { message: 'MIT Licensed', copyright: 'inference-learn · 从零理解 LLM 推理引擎' },
...
const enThemeConfig = {
  ...
  sidebar: [
    {
      ...
      items: [{ text: 'Table of Contents', link: '/en/README' }]
    },
    {
  ...
  footer: { message: 'MIT Licensed', copyright: 'inference-learn · Understand LLM Inference from Scratch' },
